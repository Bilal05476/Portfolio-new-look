...
const serviceData = [
  {
    ...
    serviceTagLine: "Website thats sells",
    serviceDesc:
      "Website development is the building and maintenance of websites; it's the work that happens behind the scenes to make a website look great, work fast and perform well with a seamless user experience.",
  },
  {
    serviceIcon: <Fa500Px />,
    serviceName: "Creative Designing",
    serviceTagLine: "Turn product into brand",
    serviceDesc:
  ...
  // },
  {
    ...
    serviceTagLine: "83% of consumers are on mobile",
    serviceDesc:
      "Mobile Application Development is the building and maintenance of Mobile Applications; it's the work that happens behind the scenes to make a application look great, work fast and perform well with a seamless user experience.",
  },
];
